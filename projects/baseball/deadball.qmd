...
ui <- fluidPage(fluidRow(
  sidebarPanel(
    ...
    column(4,tableOutput("scorecard"))
    ),
  fluidRow(column(width=2,
                  textOutput("innings"),textOutput("outs"), textOutput("score"),   
  ),column(width =2, textOutput("player"),textOutput("outcome"), textOutput("roll")),column(2, actionButton("reset", "Reset Game"))),
